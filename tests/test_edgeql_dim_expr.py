...
class TestDimExprPropertySpecializedOnLeft(TestDimExpr):
    SCHEMA = os.path.join(
        os.path.dirname(__file__), 'schemas',
        'dim_expr_left.esdl'
    )
...
class TestDimExprPropertySpecializedOnRight(TestDimExpr):
    SCHEMA = os.path.join(
        os.path.dirname(__file__), 'schemas',
        'dim_expr_right.esdl'
    )
...
class TestDimExprPropertySpecializedOnBoth(TestDimExpr):
    SCHEMA = os.path.join(
        os.path.dirname(__file__), 'schemas',
        'dim_expr_both.esdl'
    )
